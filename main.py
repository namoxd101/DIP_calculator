...
class MyCalculator:
    def __init__(self):
        ...
        self.button = tk.Button(self.root, text="5", font=('Comic Sans MS', 25))
        self.button.place(x=185, y=340)
        self.button = tk.Button(self.root, text="6", font=('Comic Sans MS', 25))
        self.button.place(x=285, y=340)
        self.button = tk.Button(self.root, text="1", font=('Comic Sans MS', 25))
        self.button.place(x=85, y=440)
        self.button = tk.Button(self.root, text="2", font=('Comic Sans MS', 25))
        self.button.place(x=185, y=440)
        self.button = tk.Button(self.root, text="3", font=('Comic Sans MS', 25))
        self.button.place(x=285, y=440)
        self.button = tk.Button(self.root, text="+/-", font=('Comic Sans MS', 25))
        self.button.place(x=85, y=540)
        self.button = tk.Button(self.root, text="0", font=('Comic Sans MS', 25))
